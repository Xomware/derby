  ...
  return (
    <>
      <section className="pt-8 pb-6 text-center">
        <p className="font-display text-rose-red text-sm uppercase tracking-[0.3em]">
          The Sun Oracle has spoken
        </p>
        <h1 className="font-display text-4xl sm:text-5xl text-rose-dark mt-2">
          {picks?.event.name ?? "Grant's Derby Picks"}
        </h1>
