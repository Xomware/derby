...
def serialize_pick(pick: dict, votes: list[dict], usernames_by_user_id: dict[str, str], current_user_id: str | None) -> dict:
    ...
    return {
        ...
        "final_take": _to_str_or_none(pick.get("final_take")),
        "record": _to_str_or_none(pick.get("record")),
        "beyer": _to_str_or_none(pick.get("beyer")),
        "brisnet": _to_str_or_none(pick.get("brisnet")),
        "equibase_rating": _to_str_or_none(pick.get("equibase_rating")),
        "last_race": _to_str_or_none(pick.get("last_race")),
        "style": _to_str_or_none(pick.get("style")),
